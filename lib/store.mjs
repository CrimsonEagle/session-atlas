...
export class Store {
 constructor(cacheFile) {this.cacheFile=cacheFile;this.files={};this.repos=new Map();this.claudeLimits=null;this.scanCount=0;this.lastScan=null;}
 ...
 snapshot(settings) {
  ...
  return {sessions:[...groups.values()].sort((a,b)=>(b.lastActivity||'').localeCompare(a.lastActivity||'')),limits,claudeBridge,lastScan:this.lastScan,stats:this.stats,priceDate};
 }
}
