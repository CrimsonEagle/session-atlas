...
export function newState(tool,file) {
 return {tool,file,offset:0,id:path.basename(file,'.jsonl'),cwd:'',title:'',branch:'',model:'unknown',tier:'standard',effort:'',origin:'',started:null,lastActivity:null,events:{},records:{},limits:{},totals:null,malformed:0,contextWindow:null,contextUsed:null,subagent:file.includes('subagents')};
}
