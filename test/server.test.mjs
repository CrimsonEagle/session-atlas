...
test('HTTP API is local, rejects foreign origins/mutations, validates settings and shuts down',async t=>{
 ...
 for(const [asset,type] of [['i18n.js','text/javascript'],['background.js','text/javascript'],['pixi-background.js','text/javascript'],['vendor/pixi-8.21.0.mjs','text/javascript'],['vendor/pixi-csp-8.21.0.mjs','text/javascript'],['background.css','text/css'],['app-icon.png','image/png'],['favicon.png','image/png']]){
