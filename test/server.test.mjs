...
test('HTTP API is local, rejects foreign origins/mutations, validates settings and shuts down',async t=>{
 ...
 for(const [asset,type] of [['background.js','text/javascript'],['pixi-background.js','text/javascript'],['vendor/pixi-8.18.0.mjs','text/javascript'],['vendor/pixi-csp-8.18.0.mjs','text/javascript'],['background.css','text/css']]){
