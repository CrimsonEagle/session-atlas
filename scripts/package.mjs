...
for(const name of ['package.json','server.mjs','launcher.mjs','Start.cmd','README.md','LICENSE','lib','public','bridge','scripts/package.mjs','scripts/benchmark-scan.mjs','docs/scan-performance.md'])await collect(name);
