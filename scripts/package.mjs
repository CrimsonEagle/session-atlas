...
for(const name of ['package.json','server.mjs','launcher.mjs','Start.cmd','README.md','LICENSE','lib','public','bridge','scripts/package.mjs','scripts/benchmark-scan.mjs','docs/scan-performance.md','docs/e2-logformat-audit.md'])await collect(name);
...
for(const entry of entries) {
 ...
 const dir=Buffer.alloc(46);dir.writeUInt32LE(0x02014b50);dir.writeUInt16LE(20,4);dir.writeUInt16LE(20,6);dir.writeUInt16LE(0x800,8);dir.writeUInt16LE(8,10);dir.writeUInt16LE(0x5d2b,14);dir.writeUInt32LE(crc,16);dir.writeUInt32LE(compressed.length,20);dir.writeUInt32LE(data.length,24);dir.writeUInt16LE(name.length,28);dir.writeUInt32LE(offset,42);central.push(dir,name);
