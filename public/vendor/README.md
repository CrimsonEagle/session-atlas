...
- `pixi-8.18.0.mjs`: https://pixijs.download/v8.18.0/pixi.min.mjs (unmodified).
- `pixi-csp-8.18.0.mjs`: https://cdn.jsdelivr.net/npm/pixi.js@8.18.0/dist/packages/unsafe-eval.js
