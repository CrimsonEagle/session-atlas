...
export function comparisonView({currentSessions,previousSessions,currentRange,previousRange,metric='tokens',dimension='repository',sortKey='delta',sortDirection='desc',esc,num,compact,money,basename,toolName}) {
