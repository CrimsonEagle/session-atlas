...
const phrases={
 ...
 'Datenströme · pausiert automatisch in unsichtbaren Tabs.':'Data streams · pauses automatically in hidden tabs.',
 'Resonanz · pausiert automatisch in unsichtbaren Tabs.':'Resonance · pauses automatically in hidden tabs.',
 'Aurora · pausiert automatisch in unsichtbaren Tabs.':'Aurora · pauses automatically in hidden tabs.',
 'Konstellation · pausiert automatisch in unsichtbaren Tabs.':'Constellation · pauses automatically in hidden tabs.',
 ...
 'Sortiert nach angezeigten Werten je Baumebene':'Sorted by displayed values within each tree level',
 'Aufgabe':'Task',
 'Aufgaben':'Tasks',
 'Sub-Sessions':'child sessions',
 'Sub-Session':'child session',
 'inkl. Sub-Sessions':'including child sessions',
 'Aufklappen':'Expand',
 'Zuklappen':'Collapse',
 'Summe':'total',
 ...
 'Hintergrundmotiv':'Background motif',
 ...
 'Die Desktop-Datei verweist auf diesen Ordner. Nach einem Umzug oder Node-Wechsel bitte neu aktivieren.':'The desktop entry points to this folder. Re-enable it after moving the folder or changing Node.',
 'Auf diesem Betriebssystem ist Windows-Autostart nicht verfügbar.':'Windows startup is unavailable on this operating system.',
 'Auf diesem Betriebssystem ist Autostart nicht verfügbar.':'Startup is unavailable on this operating system.',
 ...
 'App beendet. Zum Starten sh Start.sh ausführen.':'App stopped. Run sh Start.sh to start it again.',
 'App beendet. Zum Starten node launcher.mjs ausführen.':'App stopped. Run node launcher.mjs to start it again.',
 ...
 'Starte die App und lade diese Seite neu.':'Start the app and reload this page.',
 ...
 'Linux-Autostart aktiviert.':'Linux startup enabled.',
 'Linux-Autostart entfernt.':'Linux startup removed.',
 ...
 'Allgemein':'General',
  'Oberfläche':'Appearance',
  'Aktualisierung':'Refresh',
  'Sprache & Design':'Language & design',
  'Lege fest, wie Session Atlas automatisch aktualisiert wird.':'Set how Session Atlas refreshes automatically.',
  'Passe Sprache, Farbwelt und Bewegung der Oberfläche an.':'Adjust the interface language, color theme, and motion.',
  'Theme':'Theme',
  'Darstellungsmodus':'Display mode',
  'System folgt der Einstellung deines Geräts.':'System follows your device setting.',
  'Jede Farbwelt hat eine helle und eine dunkle Variante.':'Every theme has a light and a dark variant.',
  'Klassisch':'Classic',
  'Die bisherigen Farben':'The original colors',
  'Lagune':'Lagoon',
  'Klares Türkis und tiefes Blau':'Clear turquoise and deep blue',
  'Bernstein':'Amber',
  'Warme, ruhige Kontraste':'Warm, calm contrast',
  'Schiefer':'Slate',
  'Neutral und konzentriert':'Neutral and focused',
  'Die Auswahl wirkt sofort und gilt nur in diesem Browser.':'The selection takes effect immediately and applies only in this browser.',
 ...
 'Sprache':'Language',
 'Die Sprache ändert sich sofort und gilt nur in diesem Browser.':'The language changes immediately and applies only in this browser.',
 'Deutsch':'German',
 'Englisch':'English',
...
Object.assign(phrases,{
 ...
 'Punkte zeigen arithmetische Mittelwerte je Resetfenster. Linien und Hüllkurven zeigen denselben robusten Trend der Einzelmessungen wie in der Einzelansicht.':'Dots show arithmetic means per reset window. Lines and envelopes show the same robust trend of individual measurements as in the individual view.',
 'Blasse Punkte zeigen einzelne Hochrechnungen. Durchgehende Linien zeigen einen robusten Trend aus benachbarten Messungen; fehlende Modellpreise zählen weniger. Dezente Hüllkurven zeigen den Rundungsbereich.':'Faint dots show individual extrapolations. Continuous lines show a robust trend from nearby measurements; missing model prices receive less weight. Subtle envelopes show the rounding range.',
 'Punkte zeigen je Resetfenster den arithmetischen Mittelwert. Linien und Hüllkurven zeigen denselben robusten Trend aus Einzelmessungen wie in der Einzelansicht. Geringe Usage und fehlende Modellpreise zählen weniger; die Hüllkurve zeigt nur die angenommene Rundungsspanne.':'Dots show the arithmetic mean for each reset window. Lines and envelopes show the same robust trend from individual measurements as in the individual view. Low usage and missing model prices receive less weight; the envelope shows only the assumed rounding range.',
 'Blasse Punkte zeigen einen Auszug der Einzelmessungen. Durchgehende Linien zeigen den robust geglätteten Trend aus benachbarten Punkten; geringe Usage und fehlende Modellpreise zählen weniger. Die Hüllkurven zeigen die Rundungsspanne des Trends, nicht die Unsicherheit durch fehlende Preise.':'Faint dots show a sample of individual measurements. Continuous lines show the robust smoothed trend from nearby points; low usage and missing model prices receive less weight. The envelopes show the trend’s rounding range, not the uncertainty from missing prices.',
 ...
 'Kosten bis dahin':'Cost up to that point','Kosten bis Messpunkt':'Cost up to measurement','100%-Schätzung':'100% estimate','Spannweite':'Range','Messpunkt-Spannweite':'Measurement spread','Rundungsbereich':'Rounding range','Messungen':'Measurements','Messpunkte mit unbekannten Preisen':'measurements with unknown prices',
 'Geschätzter API-Gegenwert des nutzbaren Kontingents:':'Estimated API value of the usable quota:',
 'Jeder Punkt zeigt den arithmetischen Mittelwert der auf 100 % hochgerechneten Messungen eines gemeldeten 5-Stunden- oder 7-Tage-Fensters.':'Each dot shows the arithmetic mean of measurements extrapolated to 100% for a reported five-hour or seven-day window.',
