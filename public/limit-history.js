...
function usageChart(points,domainPoints,esc,date,range) {
...
function costChart(points,domainPoints,esc,date,money,range,aggregation) {
...
function usageView({points,allPoints,chartPoints,toolbar,sortKey,sortDirection,esc,date,range,visibleWindows}) {
...
export function limitHistoryView({history,sessions=[],tool,mode='usage',aggregation='window',sortKey='observed',sortDirection='desc',period='30',from='',to='',visibleWindows=[300,10080],now=Date.now(),esc=String,date=String,money=value=>`$${Number(value).toFixed(2)}`}) {
 ...
 return mode==='usage'?usageView({points,allPoints,chartPoints,toolbar,sortKey,sortDirection,esc,date,range,visibleWindows:visible}):costView({points,allPoints,toolbar,sortKey,sortDirection,esc,date,money,range,aggregation,visibleWindows:visible});
}
